...
<html>
    ...
    <body class="hold-transition login-page">
            ...
            <div class="col-sm-8 col-sm-offset-2" style="margin-top: 2%;">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-footer">
                        <div class="col-xs-12">
                            <div class="pull-right">
                                <a type="button" class="btn btn-success" href="${pageContext.request.contextPath}/master/quiz-session-question">Result</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
                                var duration = 10;
                                var baseUrl = '${pageContext.request.contextPath}' + "/master";
                                ...
                                function answer(ans) {
                                    var url = baseUrl + "/quiz-session-question";
                                    document.location = url;
                                }

                                function skipQuestion() {
                                    var url = baseUrl + "/question-answer-list";
                                    document.location = url;
                                }
        </script>
